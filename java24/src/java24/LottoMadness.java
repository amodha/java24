...
public class LottoMadness extends JFrame {
    ...
    JLabel numbersLabel = new JLabel("Your pic ", JLabel.RIGHT);
    JTextField[] numbers = new JTextField[6];
    JLabel winnersLabel = new JLabel("Winne ", JLabel.RIGHT);
    ...
    JLabel drawingsLabel = new JLabel("Drawin ", JLabel.RIGHT);
    JTextField drawings = new JTextField("0");
    JLabel yearsLabel = new JLabel("Yea ", JLabel.RIGHT);
